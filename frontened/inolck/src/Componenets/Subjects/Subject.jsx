...
const features = [
  ...
  "Doubt resolution in Super Active Mentorship Groups",
  "Expert mentorship & counselling for Platinum Batches",
  "CLAT 2025 Results: AIR 1,3,6,7,8,9 & 1450+ NLU selections",
  "Mentoring sessions with a dedicated online mentor",
  "Parents-Teachers Meets to discuss academic progress",
  "Exclusive Telegram groups for discussion and mentoring",
  "Join us soon in the LegalEdge Classrooms!",
];
